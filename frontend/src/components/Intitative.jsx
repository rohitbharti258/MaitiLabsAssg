...
const Intitative = () => {
  return (
      <div className="text-center">
            ...
            <div className="flex flex-col md:flex-row justify-evenly  sm:w-1/2 m-[8px] px-[85px] py-[120px] sm:mx-auto sm:h-full h-full md:h-full p-5 bg-[#f7f1ec] rounded-xl border-2 border-[#c2bebb] mt-10">
              ...
              {InitiativeData.map((data,index)=> (
                 ...
                 <h1 className="text-[#1f3a2b] text-center font-bold mt-4">
                   {data.title}
                 </h1>
                 <h3 className="text-sm text-center" dangerouslySetInnerHTML={{ __html: data.desc }} />
                  {/* {data.desc}
                 </h3> */}
                 <button
                   name="awareness"
