            ...
            <div className="mt-[23px] w-[40%]  font-[Plus Jakarta  Sans] font-bold text-[28px] leading-[24px]">
              ...
              <div className="mt-[19px] md:text-[20px] text-[18px] font-[Gilroy-Light] font-light text-left leading-[40px]">
                <ul>
                  <li>
                    {" "}
                    <Link className="block   hover:text-[#1E3A2B]  " to="/aboutUs">
                      About
                    </Link>
                  </li>
                  <li>
                    {" "}
                    <Link className="block  hover:text-[#1E3A2B]" to="/awarenessPortal">
                      Awareness Portal
                    </Link>
                  </li>
                  <li>
                    <a className="block   hover:text-[#1E3A2B]" href="/GreenBit">
                      GreenBit
                    </a>
                  </li>
                  <li>
