...
const AboutUs = () => {
  return (
    <>
      <div
        className="cursor-default mt[54px] w-[310px] h-[71px] mx-auto text-center text-[57px] text-[#1E3A2B] font-[Gilroy-Bold] md:pt-[30px] pt-[15px]"
        id="aboutUs"
      >
        About us
      </div>
      ...
      {ContentData.map(({ imgURL, title, description }, index) => (
        <div
          ...
          } mx-auto mt-[69px] md:flex block w-[90%] `}
          key={index}
        >
